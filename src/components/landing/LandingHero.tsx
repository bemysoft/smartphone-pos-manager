      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto mt-6">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3.5">
            ...
            >
              ...
              <span>{t(hero.ctaPrimaryText)}</span>
            ...
            >
              ...
              <span>{t(hero.ctaSecondaryText)}</span>
            </button>
          </div>
          ...
          <div className="mt-4 flex flex-wrap items-center justify-center gap-4 text-xs font-semibold text-slate-500 dark:text-slate-400">
            <span className="flex items-center gap-1.5">
              <Check className="h-4 w-4 text-emerald-500 stroke-[3]" /> {t("Tanpa Perlu Kartu Kredit")}
            </span>
            <span className="flex items-center gap-1.5">
              <Check className="h-4 w-4 text-emerald-500 stroke-[3]" /> {t("Setup Cepat 2 Menit")}
            </span>
            <span className="flex items-center gap-1.5">
              <Check className="h-4 w-4 text-emerald-500 stroke-[3]" /> {t("Bantuan Migrasi Data Excel Gratis")}
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mt-12 max-w-4xl mx-auto">
          <div className="p-4 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800 backdrop-blur-xs text-center">
            ...
            <div className="text-[11px] font-semibold text-slate-500 dark:text-slate-400 mt-0.5">{t("Toko HP & Gadget Aktif")}</div>
          </div>
          <div className="p-4 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800 backdrop-blur-xs text-center">
            <div className="text-2xl sm:text-3xl font-black text-primary-600 dark:text-primary-400">4.800.000+</div>
            <div className="text-[11px] font-semibold text-slate-500 dark:text-slate-400 mt-0.5">{t("Unit IMEI Terverifikasi")}</div>
          </div>
          <div className="p-4 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800 backdrop-blur-xs text-center">
            <div className="text-2xl sm:text-3xl font-black text-emerald-600 dark:text-emerald-400">Rp 180M+</div>
            <div className="text-[11px] font-semibold text-slate-500 dark:text-slate-400 mt-0.5">{t("Omset Diproses / Bulan")}</div>
          </div>
          <div className="p-4 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800 backdrop-blur-xs text-center">
            <div className="text-2xl sm:text-3xl font-black text-amber-500">99.98%</div>
            <div className="text-[11px] font-semibold text-slate-500 dark:text-slate-400 mt-0.5">{t("Uptime Cloud SLA")}</div>
          </div>
        </div>
